...
public class BugDetailsPage extends AbstractPage {
    ...
    @FindBy(className = "bz_bug_link")
    private WebElement createdBugLink;

    @FindBy(xpath = "//table[@class='bz_comment_table']//div[@class='bz_comment']")
    ...
    public String getLastComment() {
        ...
        WebElement preElement = lastComment.findElement(By.tagName("pre"));
    ...
    public BugDetailsPage gotoCreatedBug() {
        createdBugLink.click();
        return PageFactory.initElements(driver, BugDetailsPage.class);
    }
